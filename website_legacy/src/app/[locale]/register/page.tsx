      ...
      {googleAvailable && (
        <>
          <button
            ...
            className="w-full flex items-center justify-center gap-2 border border-gray-300 dark:border-gray-800 rounded py-2 text-sm font-medium hover:bg-gray-50 dark:hover:bg-gray-900 transition mb-6"
          >
